...
const CODE_HINT_DEFAULT = '发送至邮箱后有效期 10 分钟'
const REMEMBER_EMAIL_KEY = 'gl-blog:remember-email'
const ACCESS_TOKEN_KEY = 'gl-blog:access-token'
const REFRESH_TOKEN_KEY = 'gl-blog:refresh-token'
const EXPIRES_IN_KEY = 'gl-blog:expires-in'
